...
const Navbar = ({button, url}) => {
    ...
    const handleClick = () => {
        if(button === "Get Started") targetRef.current?.scrollIntoView({behavior:'smooth'});
    ...
    return (  
        <div className="top-0 flex justify-between items-center w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800 border-b border-gray-200">
            <div className="flex flex-row items-center justify-between p-3 cursor-pointer ml-16">
                <a href="/">
                    <Image
                    src="/logonav.svg"
                    alt="navbar Logo"
            ...
            <div>
                <nav  className="flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
                    ...
                    <a   onClick={handleClick} className="inline-flex items-center justify-center transition duration-300 px-5 py-3 mr-16 text-base font-medium text-center rounded-lg ring-2 ring-cyan-700 hover:bg-cyan-700 hover:text-white cursor-pointer">
                        {button}
